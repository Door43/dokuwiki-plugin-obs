...
class Door43obs_Plugin_Base extends DokuWiki_Syntax_Plugin {
    ...
    protected $langStringKey;

    function __construct($pluginName, $tagName, $templateFileName, $langStringKey) {

        $this->root = dirname(dirname(__FILE__));
        $this->newMode = "plugin_door43obs_{$pluginName}";
